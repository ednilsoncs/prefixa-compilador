...
public final class AMenorIgualQueOperacao extends POperacao
{
    private PStmt _stmt_;
    private PStmt _stmtR_;

    public AMenorIgualQueOperacao()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMenorIgualQueOperacao(
    ...
    {
        ((Analysis) sw).caseAMenorIgualQueOperacao(this);
    }
